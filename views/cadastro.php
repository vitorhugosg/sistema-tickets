...
<body id="login">
	...
	<form method="POST">
		...
		<div class="group">
			<input type="text" name="nome" id="nomeCadastro"><span class="highlight"></span><span class="bar"></span>
		...
		<div class="group">
			<input type="password" name="senhaDois"><span class="highlight"></span><span class="bar"></span>
			<label>Senha *</label>
		</div>
		...
		<h6 class="ou">ou</h6>
		<a type="button" class="button buttonRed"  href="<?php echo BASE_URL; ?>/login">Login
			<div class="ripples buttonRipples"><span class="ripplesCircle"></span></div>
		</a>
	</form>
